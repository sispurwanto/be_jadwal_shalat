...
// Pastikan body diserialisasi ke JSON string. Gunakan JSON_UNESCAPED_UNICODE agar karakter utf tetap rapi.
...
try {
    // Simpan ke database
    // $sql = "INSERT INTO nasehat (id_masjid, body) VALUES (:id_masjid, :body)";
    $sql = "
        INSERT INTO nasehat (id_masjid, body)
